...
export const AuthProvider = ({ children }) => {
  ...
  const loginUser = async (email, password) => {
    ...
    const res = await fetch('https://eduforall.vercel.app/api/v1/auth/login', {
      method: 'POST',
  ...
  const registerUser = async (formData) => { 
    ...
    const res = await fetch('https://eduforall.vercel.app/api/v1/auth/register', {
      method: 'POST',
      body: JSON.stringify(formData),
      headers: {
          "Content-Type": 'application/json'
  ...
  const logoutUser = async () => {
    const res = await fetch('https://eduforall.vercel.app/api/v1/auth/logout', {
      method: 'POST',
    })
  ...
  //   // ...
  //   const res = await fetch('https://eduforall.vercel.app/api/v1/auth/refresh', {
  //     method: 'POST',
  //     credentials: 'include'
  //   })
